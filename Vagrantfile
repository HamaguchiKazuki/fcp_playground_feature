...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "master" do |atomic|
    ...
    atomic.vm.provision :shell, path: "./deployments/vm/docker-install.sh"
    atomic.vm.provision :shell, path: "./deployments/vm/permission.sh"
    atomic.vm.provision :shell, path: "./deployments/vm/kubeadm_install.sh"
    atomic.vm.provision :shell, path: "./deployments/vm/lanch_kubeadm.sh"
  end
  ...
  config.vm.define "python" do |atomic|
    atomic.vm.hostname="python.atomichost"
    atomic.vm.network "private_network", ip: "192.168.33.44"
